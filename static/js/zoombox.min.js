...
<img class='zoombox-image slide' src='${clientRootDir}static/images/zoombox/load.svg'>
...
<img class='zoombox-close zoombox-controls' src='${clientRootDir}static/images/zoombox/close.png'>
<img class='zoombox-next zoombox-controls' src='${clientRootDir}static/images/zoombox/next.png'>
<img class='zoombox-prev zoombox-controls' src='${clientRootDir}static/images/zoombox/prev.png'>
<img class='zoombox-play zoombox-controls' src='${clientRootDir}static/images/zoombox/play.png'>
<img class='zoombox-zoom-in zoombox-controls' src='${clientRootDir}static/images/zoombox/zoom-in.svg'>
<img class='zoombox-zoom-out zoombox-controls' src='${clientRootDir}static/images/zoombox/zoom-out.svg'>
...
class zoomboxImages {
    ...
    putImage() {
        ...
        this.zoomboxImage.src = `${clientRootDir}static/images/zoombox/load.svg`;
    ...
    checkPlay(isplay) {
        ...
        if (isplay) {
            this.isplaying = !1;
            this.zoomboxPlay.src = `${clientRootDir}static/images/zoombox/play.png`;
            clearTimeout(this.slideTimeOut)
        } else {
            this.isplaying = !0;
            this.zoomboxPlay.src = `${clientRootDir}static/images/zoombox/pause.png`;
            this.slideShow()
        }
    }
    ...
    groupName.forEach((group) => {
        ...
        images.forEach((img, index) => {
            img.onclick = () => {
                ...
                console.log('execute');
                zoombox.execute();
                document.querySelector('.zoombox-close').src = `${clientRootDir}static/images/zoombox/close.png`;
                document.querySelector('.zoombox-zoom-in').src = `${clientRootDir}static/images/zoombox/zoom-in.svg`;
                document.querySelector('.zoombox-zoom-out').src = `${clientRootDir}static/images/zoombox/zoom-out.svg`;
                document.querySelector('.zoombox-next').src = `${clientRootDir}static/images/zoombox/next.png`;
                document.querySelector('.zoombox-prev').src = `${clientRootDir}static/images/zoombox/prev.png`;
                document.querySelector('.zoombox-play').src = `${clientRootDir}static/images/zoombox/play.png`
            }
        })
    })
}
